...
const services = [
  ...
  },
  {
    ...
    description: 'We design and build end-to-end data platforms — from ingestion pipelines to interactive dashboards — enabling data-driven decisions at every level of your organization.',
    offerings: [
